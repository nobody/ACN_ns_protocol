...
set nf [open cross_links.nam w]
$ns namtrace-all $nf

set tr [open cross_links.tr w]
$ns trace-all $tr
...
$ns duplex-link $host0_if1 $host3_if1 5Mb 20ms DropTail

$ns duplex-link $host2_if0 $host3_if0 5Mb 20ms DropTail
$ns duplex-link $host2_if1 $host1_if1 5Mb 20ms DropTail
